   ...
   echo "OTFname rheology OTF FZ1 FZ2 MOR1 MOR2 MOR3 MOR4 IC1 OC1 IC2 OC2 OTF_min OTF_max MOR1_min MOR1_max MOR2_min MOR2_max MOR3_min MOR3_max MOR4_min MOR4_max" >Results/averageMoho_${dataname}.txt
    ...
    for i in {0..3}; do
        ...
        # 3.2  Extract average thermal gravity & RMBA & Moho values for all boxes
          ...
          # MOR3
            gmt grdcut $grav_therm_minusMeanValue -F../inputs/averageBox_Ridge3.lonlat -Gtmp_cut_box.nc
            meanThermal_mor3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $rmba -F../inputs/averageBox_Ridge3.lonlat -Gtmp_cut_box.nc
            meanRMBA_mor3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $moho -F../inputs/averageBox_Ridge3.lonlat -Gtmp_cut_box.nc
            meanMoho_mor3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc`
            minMoho_mor3=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $3}'`
            maxMoho_mor3=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $5}' && rm tmp_cut_box.nc`
          # MOR4
            gmt grdcut $grav_therm_minusMeanValue -F../inputs/averageBox_Ridge4.lonlat -Gtmp_cut_box.nc
            meanThermal_mor4=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $rmba -F../inputs/averageBox_Ridge4.lonlat -Gtmp_cut_box.nc
            meanRMBA_mor4=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $moho -F../inputs/averageBox_Ridge4.lonlat -Gtmp_cut_box.nc
            meanMoho_mor4=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc`
            minMoho_mor4=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $3}'`
            maxMoho_mor4=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $5}' && rm tmp_cut_box.nc`
          # IC1
        ...
        # write to file
        echo ${dataname} ${etaname} ${meanValue_OTF} ${meanRMBA_otf1} ${meanRMBA_fz1} ${meanRMBA_fz2} ${meanRMBA_mor3} ${meanRMBA_mor4} ${meanRMBA_mor2} ${meanRMBA_mor1} ${meanRMBA_ic2} ${meanRMBA_oc2} ${meanRMBA_ic1} ${meanRMBA_oc1} >>Results/averageRMBA_${dataname}.txt
        echo ${dataname} ${etaname} ${meangrav_thermal} ${meanThermal_otf1} ${meanThermal_fz1} ${meanThermal_fz2} ${meanThermal_mor3} ${meanThermal_mor4} ${meanThermal_mor2} ${meanThermal_mor1} ${meanThermal_ic2} ${meanThermal_oc2} ${meanThermal_ic1} ${meanThermal_oc1} >>Results/averageThermal_${dataname}.txt
        echo ${dataname} ${etaname} ${meanMoho_otf1} ${meanMoho_fz1} ${meanMoho_fz2} ${meanMoho_mor3} ${meanMoho_mor4} ${meanMoho_mor2} ${meanMoho_mor1} ${meanMoho_ic2} ${meanMoho_oc2} ${meanMoho_ic1} ${meanMoho_oc1} ${minMoho_otf1} ${maxMoho_otf1} ${minMoho_mor3} ${maxMoho_mor3} ${minMoho_mor4} ${maxMoho_mor4} ${minMoho_mor2} ${maxMoho_mor2} ${minMoho_mor1} ${maxMoho_mor1} >>Results/averageMoho_${dataname}.txt
        ...
        gmt subplot begin 5x4 -A+JTL+o0.5c -Fs15c/9c -M0.5c/1.5c -R$faa -JM15c -Ba1df30m -BWSne -T"Gravity anomaly estimated from rheology-dependence thermal models: "$dataname
            ...
            gmt subplot set 0,3
              ...
              # plot the all boxes
                ...
                gmt plot ../inputs/averageBox_Ridge3.lonlat -W0.5p,purple -L -Gwhite@50
                gmt plot ../inputs/averageBox_Ridge4.lonlat -W0.5p,purple -L -Gwhite@50
                ...
                lonClatC_box_mor3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                angle_rot_mor3=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                echo $lonClatC_box_mor3 $meanThermal_mor3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor3
                lonClatC_box_mor4=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                angle_rot_mor4=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                echo $lonClatC_box_mor4 $meanThermal_mor4 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor4
                #IC/OC
            ...
            gmt subplot set 1,3
              ...
              # plot the all boxes
                ...
                lonClatC_box_mor3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                angle_rot_mor3=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                echo $lonClatC_box_mor3 $meanRMBA_mor3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor3
                lonClatC_box_mor4=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                angle_rot_mor4=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                echo $lonClatC_box_mor4 $meanRMBA_mor4 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor4
                #IC/OC
                lonClatC_ic1=`awk -v indBox=1 'NR==(1+(indBox-1)*5){print $4, $5}' $nbox_icoc`
                angle_rot_ic1=`awk -v indBox=1 'NR==(1+(indBox-1)*5){if($6>90 || $6<-90){print $6-180}else{print $6}}' $nbox_icoc`
            ...
            gmt subplot set 2,3
              ...
              # plot the all boxes
                ...
                lonClatC_box_mor3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                angle_rot_mor3=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge3.lonlat`
                echo $lonClatC_box_mor3 $meanMoho_mor3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor3
                lonClatC_box_mor4=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                angle_rot_mor4=`awk '{print $3}' ../inputs/BoxC_averageBox_Ridge4.lonlat`
                echo $lonClatC_box_mor4 $meanMoho_mor4 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_mor4
                #IC/OC
                lonClatC_ic1=`awk -v indBox=1 'NR==(1+(indBox-1)*5){print $4, $5}' $nbox_icoc`
                angle_rot_ic1=`awk -v indBox=1 'NR==(1+(indBox-1)*5){if($6>90 || $6<-90){print $6-180}else{print $6}}' $nbox_icoc`
