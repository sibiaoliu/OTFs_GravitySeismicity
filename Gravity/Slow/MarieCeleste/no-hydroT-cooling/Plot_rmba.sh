...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../romaO.cpt+h -I -T-16/12/1 -Z >grav_diff.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-14/23/1 -Z >grav_diff2.cpt
    gmt makecpt -C../../../roma.cpt+h -I -T-3/3/1 -Z >grav_moho.cpt
    gmt makecpt -C../../../vikO.cpt+h -T-45/35/5 -Z >grav_therm.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-50/65/5 -Z >grav_rmba.cpt
