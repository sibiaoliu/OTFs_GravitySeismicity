...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../romaO.cpt+h -I -T-8/10/1 -Z >grav_diff.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-8/10/1 -Z >grav_diff2.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-40/30/1 -Z >grav_faa.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-40/40/1 -Z >grav_rmba.cpt
