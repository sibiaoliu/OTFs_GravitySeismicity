...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../romaO.cpt+h -I -T-45/30/1 -Z >grav_diff.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-6/30/1 -Z >grav_diff2.cpt
    gmt makecpt -C../../../roma.cpt+h -I -T-3/3/1 -Z >grav_moho.cpt    
    gmt makecpt -C../../../vikO.cpt+h -T-60/50/10 -Z >grav_therm.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-100/80/10 -Z >grav_rmba.cpt
