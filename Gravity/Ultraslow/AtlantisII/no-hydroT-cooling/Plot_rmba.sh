...
#===== Input parameters' value change=====
    ...
    Etas=(hsc3 isov3 disl3 vp3)
    gmt makecpt -C../../../romaO.cpt+h -I -T-20/16/1 -Z >grav_diff.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-5/24/1 -Z >grav_diff2.cpt
    gmt makecpt -C../../../roma.cpt+h -I -T-3/3/1 -Z >grav_moho.cpt    
    gmt makecpt -C../../../vikO.cpt+h -T-60/30/10 -Z >grav_therm.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-40/100/10 -Z >grav_rmba.cpt
