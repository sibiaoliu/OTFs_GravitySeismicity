...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../romaO.cpt+h -I -T-20/20/1 -Z >grav_diff.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-10/33/1 -Z >grav_diff2.cpt
    gmt makecpt -C../../../roma.cpt+h -I -T-3/3/1 -Z >grav_moho.cpt    
    gmt makecpt -C../../../vikO.cpt+h -T-60/30/10 -Z >grav_therm.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-60/50/10 -Z >grav_rmba.cpt
...
# 3. Calculate RMBA field with rheology-dependence mantle thermal model
  ...
  # (3) getAverageBox_TF_FZ; (4)getAverageBox_Ridge; (5) getAverageBox_ICOC    
    ...
    for i in {0..4}; do
        ...
        # write to file
        echo ${dataname} ${etaname} ${meanValue_OTF} ${meanRMBA_otf1} ${meanRMBA_fz2} ${meanRMBA_fz1} ${meanRMBA_mor1} ${meanRMBA_mor2} ${meanRMBA_oc1} ${meanRMBA_ic1} ${meanRMBA_oc2} ${meanRMBA_ic2} >>Results/averageRMBA_${dataname}.txt
        echo ${dataname} ${etaname} ${meangrav_thermal} ${meanThermal_otf1} ${meanThermal_fz2} ${meanThermal_fz1} ${meanThermal_mor1} ${meanThermal_mor2} ${meanThermal_oc1} ${meanThermal_ic1} ${meanThermal_oc2} ${meanThermal_ic2} >>Results/averageThermal_${dataname}.txt
        echo ${dataname} ${etaname} ${meanMoho_otf1} ${meanMoho_fz2} ${meanMoho_fz1} ${meanMoho_mor1} ${meanMoho_mor2} ${meanMoho_oc1} ${meanMoho_ic1} ${meanMoho_oc2} ${meanMoho_ic2} ${minMoho_otf1} ${maxMoho_otf1} ${minMoho_mor1} ${maxMoho_mor1} ${minMoho_mor2} ${maxMoho_mor2} >>Results/averageMoho_${dataname}.txt
