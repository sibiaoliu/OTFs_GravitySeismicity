...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../vikO.cpt+h -T-40/60/2 -Z >grav_therm.cpt
...
# 3. Calculate RMBA field with rheology-dependence mantle thermal model
  ...
  # (3) getAverageBox_TF_FZ; (4)getAverageBox_Ridge; (5) getAverageBox_ICOC    
    ...
    #gmt grdmath ${mba} $grav_therm_hsc SUB = rmba_hsc.nc
    ...
    for i in {0..3}; do
        ...
        gmt grdmath $grav_therm $meangrav_thermal_hsc SUB = $grav_therm_minusMeanValue
        ...
        gmt grdmath ${rmba} ${meanValue_Mean} SUB = ${rmba}
        gmt grdgradient ${rmba} -A30 -Nt0.6 -Qc -G${rmba}.grad
        echo $meanValue_Mean >meanRMBA_${etaname}.txt
        ...
        # write to file
        echo ${dataname} ${etaname} ${meanValue_Mean} ${meanRMBA_otf1} ${meanRMBA_fz1} ${meanRMBA_fz2} ${meanRMBA_mor1} ${meanRMBA_mor2} ${meanRMBA_ic1} ${meanRMBA_oc1} ${meanRMBA_ic2} ${meanRMBA_oc2} >>Results/averageRMBA_${dataname}.txt
        echo ${dataname} ${etaname} ${meangrav_thermal} ${meanThermal_otf1} ${meanThermal_fz1} ${meanThermal_fz2} ${meanThermal_mor1} ${meanThermal_mor2} ${meanThermal_ic1} ${meanThermal_oc1} ${meanThermal_ic2} ${meanThermal_oc2} >>Results/averageThermal_${dataname}.txt
