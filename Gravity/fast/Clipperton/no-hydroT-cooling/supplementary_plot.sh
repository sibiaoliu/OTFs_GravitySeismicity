...
#===== Input parameters' value change=====
    ...
    #gmt makecpt -C../../../basecpt_MBA.cpt+h -I -T-30/20/5 -Z >grav_mba.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-35/25/1 -Z >grav_rmba.cpt
    gmt makecpt -C../../../romaO.cpt+h -I -T-20/20/5 -Z >grav_faa.cpt
...
# Plot the figure, including
    ...
    figwidth=7
    figheight=`gmt_get_map_height -R$fullrmba_vp  -JM${figwidth}c`
    move_x=10
    move_y=10
    dx=0.5
    dy=1.7
    ...
    gmt begin ${dataname}_supplement pdf
        # Bathymetry
