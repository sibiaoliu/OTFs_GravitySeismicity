...
#===== Input parameters' value change=====
    ...
    gmt makecpt -C../../../vikO.cpt+h -T-25/25/1 -Z >grav_therm.cpt
    gmt makecpt -C../../../basecpt_grav.cpt+h -T-15/20/1 -Z >grav_rmba.cpt
...
# 3. Calculate RMBA field with rheology-dependence mantle thermal model
  ...
  # (3) getAverageBox_TF_FZ; (4)getAverageBox_Ridge; (5) getAverageBox_ICOC    
    echo "#OTFname rheology RMBAshift OTF1 OTF2 OTF3 FZ1 FZ2 MOR1 MOR2 IC1 OC1 IC2 OC2" >Results/averageRMBA_${dataname}.txt
    echo "#OTFname rheology mean_thermal OTF1 OTF2 OTF3 FZ1 FZ2 MOR1 MOR2 IC1 OC1 IC2 OC2" >Results/averageThermal_${dataname}.txt 
    echo "OTFname rheology OTF1 OTF2 OTF3 FZ1 FZ2 MOR1 MOR2 IC1 OC1 IC2 OC2 OTF1_min OTF1_max OTF2_min OTF2_max OTF3_min OTF3_max MOR1_min MOR1_max MOR2_min MOR2_max" >Results/averageMoho_${dataname}.txt
    # we consider the hsc model as the reference model
    gravity_xyz2grd grav_hsc
    grav_therm_hsc=grav_hsc.nc
    # reference mean value from the hscthermal gravity
    ...
    for i in {0..4}; do
        ...
        # 3.2  Extract average thermal gravity & RMBA & Moho values for all boxes
          ...
          # OTF2  
            gmt grdcut $grav_therm_minusMeanValue -F../inputs/averageBox_OTF2.lonlat -Gtmp_cut_box.nc
            meanThermal_otf2=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $rmba -F../inputs/averageBox_OTF2.lonlat -Gtmp_cut_box.nc
            meanRMBA_otf2=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $moho -F../inputs/averageBox_OTF2.lonlat -Gtmp_cut_box.nc
            meanMoho_otf2=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc`
            minMoho_otf2=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $3}'`
            maxMoho_otf2=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $5}' && rm tmp_cut_box.nc`
          # OTF3
            gmt grdcut $grav_therm_minusMeanValue -F../inputs/averageBox_OTF3.lonlat -Gtmp_cut_box.nc
            meanThermal_otf3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc`
            gmt grdcut $rmba -F../inputs/averageBox_OTF3.lonlat -Gtmp_cut_box.nc
            meanRMBA_otf3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc tmp_cut_box.nc` 
            gmt grdcut $moho -F../inputs/averageBox_OTF3.lonlat -Gtmp_cut_box.nc
            meanMoho_otf3=`gmt grdmath tmp_cut_box.nc MEAN = tmp.nc && gmt grdinfo tmp.nc | grep "v_min" | awk '{printf "%.1f", $3}' && rm tmp.nc`
            minMoho_otf3=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $3}'`
            maxMoho_otf3=`gmt grdinfo tmp_cut_box.nc | grep "v_max" | awk '{printf "%.1f", $5}' && rm tmp_cut_box.nc`           
          # FZ1
        ...
        # write to file
        echo ${dataname} ${etaname} ${meanValue_OTF} ${meanRMBA_otf1} ${meanRMBA_otf2} ${meanRMBA_otf3} ${meanRMBA_fz1} ${meanRMBA_fz2} ${meanRMBA_mor2} ${meanRMBA_mor1} ${meanRMBA_ic1} ${meanRMBA_oc1} ${meanRMBA_ic2} ${meanRMBA_oc2} >>Results/averageRMBA_${dataname}.txt
        echo ${dataname} ${etaname} ${meangrav_thermal} ${meanThermal_otf1} ${meanThermal_otf2} ${meanThermal_otf3} ${meanThermal_fz1} ${meanThermal_fz2} ${meanThermal_mor2} ${meanThermal_mor1} ${meanThermal_ic1} ${meanThermal_oc1} ${meanThermal_ic2} ${meanThermal_oc2} >>Results/averageThermal_${dataname}.txt
        echo ${dataname} ${etaname} ${meanMoho_otf1} ${meanMoho_otf2} ${meanMoho_otf3} ${meanMoho_fz1} ${meanMoho_fz2} ${meanMoho_mor2} ${meanMoho_mor1} ${meanMoho_ic1} ${meanMoho_oc1} ${meanMoho_ic2} ${meanMoho_oc2} ${minMoho_otf1} ${maxMoho_otf1} ${minMoho_otf2} ${maxMoho_otf2} ${minMoho_otf3} ${maxMoho_otf3} ${minMoho_mor2} ${maxMoho_mor2} ${minMoho_mor1} ${maxMoho_mor1} >>Results/averageMoho_${dataname}.txt
        ...
        gmt subplot begin 5x5 -A+JTL+o0.5c -Fs15c/9c -M0.5c/1.5c -R$faa -JM15c -Ba1df30m -BWSne -T"Gravity anomaly estimated from rheology-dependence thermal models: "$dataname
            ...
            gmt subplot set 0,4
              ...
              # plot the all boxes
                ...
                gmt plot ../inputs/averageBox_OTF2.lonlat -W0.5p,red -L -Gwhite@50
                gmt plot ../inputs/averageBox_OTF3.lonlat -W0.5p,red -L -Gwhite@50
                ...
                lonClatC_box_otf2=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                angle_rot_otf2=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                echo $lonClatC_box_otf2 $meanThermal_otf2 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf2
                lonClatC_box_otf3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                angle_rot_otf3=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                echo $lonClatC_box_otf3 $meanThermal_otf3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf3
                #fz
            ...
            gmt subplot set 1,4
              ...
              # plot the all boxes
                ...
                lonClatC_box_otf2=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                angle_rot_otf2=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                echo $lonClatC_box_otf2 $meanRMBA_otf2 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf2
                lonClatC_box_otf3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                angle_rot_otf3=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                echo $lonClatC_box_otf3 $meanRMBA_otf3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf3
                #fz
                lonClatC_box_FZ1=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_FZ1.lonlat`
                angle_rot_FZ1=`awk '{print $3}' ../inputs/BoxC_averageBox_FZ1.lonlat`
            ...
            gmt subplot set 2,4
              ...
              # plot the all boxes
                ...
                lonClatC_box_otf2=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                angle_rot_otf2=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF2.lonlat`
                echo $lonClatC_box_otf2 $meanMoho_otf2 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf2
                lonClatC_box_otf3=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                angle_rot_otf3=`awk '{print $3}' ../inputs/BoxC_averageBox_OTF3.lonlat`
                echo $lonClatC_box_otf3 $meanMoho_otf3 | gmt text -F+f12p,Helvetica-Bold,black+a$angle_rot_otf3
                #fz
                lonClatC_box_FZ1=`awk '{print $1, $2}' ../inputs/BoxC_averageBox_FZ1.lonlat`
                angle_rot_FZ1=`awk '{print $3}' ../inputs/BoxC_averageBox_FZ1.lonlat`
